...
const Advance = ({ data, page, setPage, limit, setLimit, lastPageNo }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: 'Vehicle',
        accessor: 'vehicle' //dummy
      },
      {
        Header: 'Advance Rate(%)',
        accessor: 'advanceRate' //dummy
      },
      {
        Header: 'Advance Type',
        accessor: 'advanceType' //dummy
      },
      {
        Header: 'Amount',
        accessor: 'amount' //dummy
      },
      {
        Header: 'Description',
        accessor: 'description' //dummy
      },
      {
        Header: 'Status',
        accessor: 'status',
