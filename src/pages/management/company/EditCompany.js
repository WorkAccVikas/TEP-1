...
function EditCompany() {
  ...
  const [companyData, setComanyData] = useState(null);
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        if (file instanceof File) {
          formData.append('companyContract', file);
        } else {
          // If the file is just a URL (unchanged), append the preview URL
          formData.append('companyContract', file.preview);
        }
